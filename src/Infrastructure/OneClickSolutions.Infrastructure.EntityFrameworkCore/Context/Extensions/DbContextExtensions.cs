...
using OneClickSolutions.Infrastructure.Linq;
...
namespace OneClickSolutions.Infrastructure.EntityFrameworkCore.Context.Extensions
{
    public static class DbContextExtensions
    {
        ...
        public static TResult RunInsideTransaction<TResult>(this IUnitOfWork dbContext, Func<TResult> action,
           IsolationLevel isolationLevel = IsolationLevel.ReadCommitted)
        {
            TResult result;
            try
        ...
        /// </summary>
        public static void UpdateGraph(this IDbContext dbContext, IEnumerable<object> rootEntities)
        {
        ...
        /// This method is designed for use in disconnected scenarios.
        /// </summary>
        private static void UpdateGraph(this IDbContext dbContext, object rootEntity)
        {
